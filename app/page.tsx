...
export default function Home() {
  ...
  return (
    <div className="font-sans min-h-screen bg-slate-50">
              ...
              <div className="lg:w-3/5 relative">
                <div className="relative h-64 sm:h-80 lg:h-96">
                  ...
                  <div className="absolute top-4 left-4">
                    <span
                      className={`inline-flex items-center px-3 py-1.5 ${getCategoryColor(
            ...
            <div className="flex space-x-3 pb-2">
              {categories.map((category) => (
                <button
                  ...
                  className={`inline-flex items-center px-3 py-2 rounded-lg text-sm font-semibold whitespace-nowrap transition-all duration-200 ${
              ...
              >
                <div className="relative h-48">
                  ...
                  <div className="absolute top-3 left-3">
                    <span
                      className={`inline-flex items-center px-2.5 py-1 ${getCategoryColor(
                        post.category
                      )} text-white text-xs font-semibold rounded-full`}
                    >
                      {post.category}
                ...
                <div className="p-5">
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors">
                    {post.title}
                  </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {(selectedCategory === 'All' ? regularPosts : filteredPosts).map((post) => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-3 line-clamp-2 group-hover:text-blue-600 transition-colors leading-tight">
                  {post.title}
                </h3>
      ...
      <section className="mb-8">
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-6 sm:p-8 text-white relative overflow-hidden">
          <div className="absolute inset-0 bg-black/20"></div>
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <div className="mb-6">
              <i className="fas fa-envelope text-3xl sm:text-4xl mb-4 opacity-80"></i>
              <h2 className="text-2xl sm:text-3xl font-bold mb-4">Never Miss a Story</h2>
